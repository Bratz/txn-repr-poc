...
body("<b>results*.json are run artifacts, not records.</b> They're gitignored and "
     "regenerated by the runners; RESULTS.md and docs/V2_DIRECTION.md are the quotable "
     "record. If a results file disagrees with the docs, re-run before quoting either.")
